...
float scale = 1; 
float w = 800 * scale ; // width of image
float h = 800 * scale; // height of image
float m = 545; // Modulus/Points
float n = 224; // Multiplication Factor

void setup() {
  background(255); 
  size(800, 800); // full scale for Redbubble
